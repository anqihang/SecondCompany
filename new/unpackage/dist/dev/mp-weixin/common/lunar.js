...
var ExactDate = function() {
  return {
    ...
    fromYmdHms: function(y, m, d, hour, minute, second) {
      return this._(/* @__PURE__ */ new Date(y + "/" + m + "/" + d + " " + hour + ":" + minute + ":" + second), y, m, d);
    },
...
var Solar = function() {
  ...
  var _fromBaZi = function(yearGanZhi, monthGanZhi, dayGanZhi, timeGanZhi, sect, baseYear) {
    sect = 1 == sect ? 1 : 2;
    baseYear = void 0 == baseYear ? 1900 : baseYear;
    var l = [];
    var today = _fromDate(/* @__PURE__ */ new Date());
    ...
    return {
      ...
      getYun: function(gender) {
        ...
        var start = function() {
          ...
          const startTimeZhiIndex = start2.getHour() === 23 ? 11 : LunarUtil.getTimeZhiIndex(start2.toYmdHms().substr(11, 5));
